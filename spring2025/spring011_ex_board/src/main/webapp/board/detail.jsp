...
<div class="container"  style="margin-top:5%; min-height:500px">
	...
	<div class="text-right"    >
		 <a href="<%=request.getContextPath()%>/board/edit?bno=<%=dto.getBno()%>"  class="btn btn-danger" >수정</a> 
		 <a href="<%=request.getContextPath()%>/board/delest?bno=<%=dto.getBno()%>"  class="btn btn-danger" >삭제</a>    
		 <a href="<%=request.getContextPath()%>/board/list"  class="btn btn-info" >목록보기</a> 
	</div>						 
</div>	
