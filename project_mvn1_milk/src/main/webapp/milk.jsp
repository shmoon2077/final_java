		...
		<div id="accordion">
			...
			<div class="card my-3 bg-primary">
				<div class="card-header bg-primary">
					<a class="btn bg-danger" data-bs-toggle="collapse"
						href="#collapseOne"> 주문하기 </a>
				</div>
				<div id="collapseOne" class="collapse show"
					data-bs-parent="#accordion">
					<div class="card-body bg-primary">

						<form action="milk_insert.jsp" method="post"  onsubmit="return empty()">
							<div class="mb-3 mt-3">
								<label for="oname" class="form-label">우유 이름</label> <input
									type="text" class="form-control" id="oname"
									placeholder="주문할 우유를 적어주세요" name="oname">
							</div>
							<div class="mb-3">
								<label for="onum" class="form-label">주문 수량</label> <input
									type="Number" class="form-control" id="onum"
									placeholder="주문 수량을 입력하세요" name="onum">
							</div>
			...
			<div class="card my-3 bg-primary">
				<div class="card-header bg-primary">
					<a class="collapsed btn bg-danger" data-bs-toggle="collapse"
