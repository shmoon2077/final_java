...
/*3. 상속- 재활용
    Object    {   }
     ...
     C1       int c
 */
class A1 extends Object { int a;   public A1() { super();      } //Object ()
   // ctrl + shift + f
}
class B1 extends A1     { int b;   public B1() { super();      } //A1 () 

}
class C1 extends B1     { int c;   public C1() { super();      } //B1 ()
...
19번 1번지 {c=0} C1(){#3-1      }#3-8 c=0으로 초기화  - 인스턴스변수를 초기화해 사용가능
							←  c1 1번지
					           | main #2
-------------------------------------- 
 */
